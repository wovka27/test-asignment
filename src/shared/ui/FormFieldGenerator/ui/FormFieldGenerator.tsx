...
import { type Control, Controller, type FieldValues, get, useFormContext } from 'react-hook-form';
...
export const FormFieldGenerator: FormFieldGeneratorType = observer(({ data }) => {
  ...
  return data.map((item, index) => {
    ...
    return <Field key={item.name} control={control} item={item} error={error} />;
  });
});
